...
export default [
  ...
  route("admin", "routes/admin-layout.tsx", [
    ...
    route("monitoring/ranks", "routes/admin-monitoring-ranks.tsx"),
    route("monitoring/keywords", "routes/admin-monitoring-keywords.tsx"),
    route("monitoring/ranked-keywords", "routes/admin-monitoring-ranked-keywords.tsx"),
    route("monitoring/competitors", "routes/admin-monitoring-competitors.tsx"),
    route("monitoring/backlinks", "routes/admin-monitoring-backlinks.tsx"),
    route("monitoring/audit", "routes/admin-monitoring-audit.tsx"),
