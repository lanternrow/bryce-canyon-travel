...
import type { Route } from "./+types/admin-news-page";
...
export function meta() {
  return [{ title: `News Page | Admin | ${siteConfig.siteName}` }];
}
...
export async function loader({ request }: Route.LoaderArgs) {
  ...
  const page = await getSystemPage("news");
  return {
    ...
    seo: {
      ...
      focus_keyphrase: page?.focus_keyphrase || DEFAULT_NEWS_SEO.focus_keyphrase,
...
export async function action({ request }: Route.ActionArgs) {
  ...
  let content: Record<string, any> = DEFAULT_NEWS_PAGE;
  try {
    content = JSON.parse(raw);
  } catch {
    content = DEFAULT_NEWS_PAGE;
  }
  ...
  return redirect("/admin/pages/news?toast=News+page+saved");
}
...
export default function AdminNewsPage() {
  ...
  const rootData = useRouteLoaderData("root") as
    ...
    | undefined;
  const [data, setData] = useState(content as typeof DEFAULT_NEWS_PAGE);
  ...
  const renderedTitle = applyTitleTemplate(
    metaTitle || hero.title || "News & Guides",
    titleTemplate
  );
  ...
  return (
    <div className="px-6 py-8">
      ...
      <div className="flex items-center justify-between mb-8">
        <h1 className="text-3xl font-bold text-dark">News Page Content</h1>
        <a
          href="/news"
          target="_blank"
          rel="noopener"
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className={inputClass}
                placeholder="e.g. zion travel news"
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                className={inputClass}
                placeholder="SEO title for /news"
              />
            ...
            <div>
              ...
              <textarea
                ...
                className={inputClass}
                placeholder="SEO description for /news"
              />
              <p className="text-xs text-gray-400 mt-1">
