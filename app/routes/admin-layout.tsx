  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        href: "/admin/monitoring/keywords",
        icon: (
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      },
      {
        ...
        href: "/admin/monitoring/ranked-keywords",
        icon: (
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      {
        label: "Competitors",
        href: "/admin/monitoring/competitors",
        icon: (
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      {
        label: "Backlinks",
        href: "/admin/monitoring/backlinks",
        icon: (
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
